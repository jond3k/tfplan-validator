...
Flags:
  ...
  -g, --glob stringArray   One or more globs to find terraform workspaces. Can use double-star wildcards and negation with ! (default [**/main.tf,**/.terraform.lock.hcl,!**/modules/**/main.tf,!**/modules/**/.terraform.lock.hcl,!**/.terragrunt-cache/**])
  -h, --help               help for plan
  -i, --init-args string   A string that contains additional args to pass to terraform init`,
			stderr: `Error: unable to find workspaces in [` + wd + `] using globs [**/main.tf **/.terraform.lock.hcl !**/modules/**/main.tf !**/modules/**/.terraform.lock.hcl !**/.terragrunt-cache/**]`,
		},
	}
